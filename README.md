...
<a href="https://github.com/JaniceEstes/Cybersecurity_Project_1/blob/main/Diagrams/ELK_network_diagram3.png"><img src=https://github.com/JaniceEstes/Cybersecurity_Project_1/blob/main/Diagrams/ELK_network_diagram3.png></a>
...
***Note: The ELK stack can be highly vulnerable because of the potential exploitation of a certain method in Java that can be used to exploit specific components of the SIEM, such as Logstash. This could potentially allow malicious code to be executed within the ELK stack. This is known as the Log4j vulnerability.  Many versions of Logstash are dependent on Log4j. Mitigation strategies will vary, depending on the needs of the organization utilizing the stack. If possible, a complete wipe of the system dating back to AT LEAST before the zero-day discovery, should be seriously considered. After wiping the system, as far back as possible (taking into account the availability needs of your organization), tearing down the ELK stack and rebuilding it with the most updated versions of every component is highly recommended.*** 
